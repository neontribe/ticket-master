...
function Ticket(data) {
    data = data || {name: "nothing_here", id: "nothing_here", content: "nothing_here"};
    this.name = data.name;
    this.id = data.id;
    ...
    (function boardColTick(i) {
      ...
      _this.getTickets(col_ids[i][3], function(err, data) {
        ...
        (function tickTick(j) {  
          ...
          _this.parent.dumpJSON(currDir + newTicket.name + "/" + newTicket.name + ".json", JSON.stringify(newTicket), function() {
